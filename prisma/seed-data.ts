...
export const CONTENT: Array<{ slug: string; kind: string; title: string; body: string }> = [
  ...
  },
  {
    ...
    body: "**What temperature should reconstituted peptides be stored at?** Refrigerate reconstituted peptides at 36–46 °F (2–8 °C). Do not freeze. Do not leave at room temperature. Most reconstituted peptides are stable for approximately 28–30 days refrigerated. Store vials upright and protect them from light.",
  },
  {
  ...
  },
  {
    ...
    body: "**Can you be allergic to BAC water?** Some individuals are sensitive to benzyl alcohol, the preservative in BAC water. Symptoms can include redness or irritation at the injection site. If you experience any adverse reaction, discontinue use and consult a healthcare professional. In cases of benzyl alcohol sensitivity, sterile water for injection (single-use only) may be an alternative.",
  },
  {
  ...
  },
  {
    ...
    body: "**How long are reconstituted peptides good for?** Most reconstituted peptides remain stable for approximately 28–30 days when stored refrigerated at 36–46 °F (2–8 °C). Some peptides like semaglutide may last longer (up to 56 days), while others like TB-500 may degrade faster (14–21 days). Our plan builder tracks expiration dates automatically based on each peptide's typical shelf life.",
  },
];
