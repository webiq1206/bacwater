...
const PRODUCTS = [
  ...
  },
  {
    ...
    sku: "SYR-INS-10",
    name: "Insulin Syringes — 1 mL / 100 units, 31G × 5/16in (100 pack)",
    category: "syringes",
    description:
  ...
  },
  {
    ...
    sku: "SYR-INS-05",
    name: "Insulin Syringes — 0.5 mL / 50 units, 31G × 5/16in (100 pack)",
    category: "syringes",
    description:
  ...
  },
  {
    ...
    sku: "SYR-INS-03",
    name: "Insulin Syringes — 0.3 mL / 30 units, 31G × 5/16in (100 pack)",
    category: "syringes",
    description:
...
const CONTENT: Array<{ slug: string; kind: string; title: string; body: string }> = [
  ...
  },
  {
    ...
    body: `A peptide vial label shows: the peptide name, the strength (usually in mg), a lot number, and sometimes an expiration for the powder. The strength is the total amount of peptide inside — it's not the dose. Your dose is a fraction of the total, measured in mcg (micrograms). Confirm the strength before you calculate anything.`,
  },
  {
