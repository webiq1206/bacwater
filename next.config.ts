    ...
    return [
      {
        ...
        headers: [
          ...
          // news.google.com + www.gstatic.com in script-src, www.gstatic.com in
          // style-src, and news.google.com + www.google.com in frame-src are
          // what Google's preferred-sources publisher library needs: the script
          // itself, the overlay's assets, and the confirmation overlay's frame.
