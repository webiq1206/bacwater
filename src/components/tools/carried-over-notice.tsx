  ...
  return (
    <div className="mb-4 flex items-center gap-2.5 rounded-xl border border-border bg-surface px-3 py-2 text-xs">
      ...
      <span className="min-w-0 flex-1 text-muted-foreground">
        Your numbers came with you. Check them against this product’s label.
      </span>
      <button
        type="button"
        onClick={onClear}
        className="inline-flex min-h-11 shrink-0 items-center gap-1 font-medium text-foreground hover:underline"
      >
