...
export function SupplyChecklist({volumeMl,measurementMl}:{volumeMl?:number;measurementMl?:number}) {
 ...
 </ul><AminoWaterLink/><p className="bac-checklist-limit">The supplier’s water is for lab research only. We do not decide which product you need.</p><Link href="/tools/supplies" className="bac-inline-link">Need to count vials? Use the supply calculator</Link></section>;
}
