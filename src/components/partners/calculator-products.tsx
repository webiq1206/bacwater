  ...
  <div className={styles.toolbar}>
   <Dialog open={open} onOpenChange={setOpen}>
    ...
    <DialogContent className={styles.dialog}>
     ...
     <DialogDescription>Pick the exact product. Your entered numbers follow you to compatible calculators. Check them against the new label. Blends, solutions, water and IU keep separate values. {RESEARCH_ONLY_NOTICE}</DialogDescription>
