  ...
  <div className={styles.toolbar}>
   <Dialog open={open} onOpenChange={setOpen}>
    ...
    <DialogContent className={styles.dialog}>
     ...
     <DialogDescription>Pick the exact product. Your numbers follow you to other single-compound calculators in this tab. Check the new label. Blends, solutions and water use separate fields.</DialogDescription>
