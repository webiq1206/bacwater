...
export function ResearchHero() {
  return <section id="quick-calculator" className={`${styles.hero} ${live.heroAccent}`} aria-labelledby="home-title" data-home-hero data-hero-design="editorial-live">
    <div className={styles.copy}>
      <p className={styles.eyebrow}><span aria-hidden="true" />YOUR NUMBERS. MADE CLEAR.</p>
      ...
      <p className={styles.limit}>Use the numbers from your label and instructions. We check the math, not what to take or what to mix.</p>
    </div>
