...
const HELP={
 ...
 amount:{summary:"I don't know what amount to enter",text:"Use the amount and schedule in your own instructions. Choose Each time for one amount, or Whole week for a total you split equally. The whole vial is a different number. Do not guess. Check with the person who supplied the instructions or, for medical use, your clinician.",href:"/learn/what-you-cannot-know",link:"What the calculator cannot decide"},
