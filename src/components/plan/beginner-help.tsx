...
const HELP={
 ...
 amount:{summary:"I don't know what amount to enter",text:"Find the amount for one time, or the total for a whole week, in your own instructions. Choose the matching option and copy the unit too. How much is in the vial does not tell us how much to measure each time. Do not guess. Check with the person who supplied the instructions or, for medical use, your clinician.",href:"/learn/what-you-cannot-know",link:"What the calculator cannot decide"},
