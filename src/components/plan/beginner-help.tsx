...
const HELP={
 ...
 amount:{summary:"I don't know what amount to enter",text:"Copy the amount from your own instructions. Say whether it is for one time, one day, or one whole week. The amount in the vial is a different number. A daily or weekly total must be split using the schedule in those instructions. Do not guess. Check with the person who supplied the instructions or, for medical use, your clinician.",href:"/learn/what-you-cannot-know",link:"What the calculator cannot decide"},
