...
export const STATIC_PAGES:SitemapUrl[]=[
 ...
 {path:"/tools/syringe-units",changeFrequency:"weekly",priority:0.9},{path:"/tools/mg-to-mcg",changeFrequency:"weekly",priority:0.9},{path:"/tools/supplies",changeFrequency:"weekly",priority:0.9},
