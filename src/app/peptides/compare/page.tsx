...
export default async function ComparePage({searchParams}:{searchParams:Promise<Params>}){
 ...
 const rows=[
  ...
  {label:"Evidence source",values:[a,b].map(p=><Link className="underline" href={`/peptides/${p.slug}#studies`}>Read the linked research and its limitations</Link>)},
 ...
 return <div className="mx-auto max-w-5xl px-4 sm:px-6 pt-8 sm:pt-12 pb-24">
