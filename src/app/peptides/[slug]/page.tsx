...
export default async function PeptidePage({params}:{params:Promise<{slug:string}>}){
 ...
 <VialIdentityWarning compound={short}/><p className="mt-4 text-sm text-muted-foreground">Product names follow the partner’s catalog. The scientific references describe compounds and study materials, not proof for a supplier’s product.</p>
