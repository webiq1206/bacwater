...
import { EMPTY_MASS_ENTRY, readMassEntry } from "@/lib/session/converter-drafts";
...
export default function MgMcgConverterPage() {
  ...
  const [entry,setEntry]=useSessionDraft("conversion.mass",EMPTY_MASS_ENTRY,readMassEntry);
  ...
  <SupplyChecklist/></>}>
    <section className="rounded-2xl border border-border bg-card p-5 sm:p-7" aria-label="Mass conversion">
      ...
      <p id="mass-help" className="mt-3 text-sm text-muted-foreground">Use a decimal point, without commas. Your entry follows you between the homepage mass tab and this converter for this browser session. No account is needed.</p>
