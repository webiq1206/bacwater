...
export default function SyringeUnitConverterPage(){
 ...
 <Breadcrumbs items={[{label:"Home",href:"/"},{label:"Tools",href:"/tools"},{label:"Syringe units to mL",href:"/tools/syringe-units"}]}/><p className="eyebrow">Volume converter</p><h1 className="mt-2 text-4xl sm:text-5xl font-serif">U-100 syringe units to mL</h1><p className="mt-4 text-lg leading-relaxed">100 U-100 units equal 1 mL. Enter either value. This ratio is not valid for U-40 or another scale.</p>
 <section className="mt-6 rounded-2xl border bg-card p-5 sm:p-7" aria-label="U-100 volume conversion"><div className="grid gap-5 sm:grid-cols-2">
