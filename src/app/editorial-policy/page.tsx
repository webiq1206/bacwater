...
export default function EditorialPolicyPage() {
  return <div className="mx-auto max-w-3xl px-4 sm:px-6 pt-12 pb-24">
    ...
    <section className="mt-9 space-y-3"><h2 className="text-2xl font-serif">Research-supplier recommendations and paid links</h2><p>Our separately labeled supplier listings use WEBIQ affiliate links. We may earn a commission on eligible purchases. A financial relationship influences which supplier is featured. This is not an independent ranking or a claim that BACwater has tested a product. We disclose potential commissions beside those links.</p><p>Supplier links are kept separate from calculator results, personal inputs, and clinical questions. No supplier chooses the arithmetic or endorses the calculators. We do not publish unverified quality badges, health claims, prices, stock information, or copied customer reviews. Research-use listings are not recommendations for human or animal use.</p></section>
