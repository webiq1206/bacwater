...
export default function ProductsPage() {
  ...
  return <div className={styles.page}>
    ...
    <header className={styles.hero}><div><p className={styles.eyebrow}>The research directory</p><h1>Find the material.<br/><em>Understand the listing.</em></h1></div><div className={styles.heroLead}><p>One place to explore compounds, blends, solutions and lab water. Start with a name, or tell us what you are looking for.</p><p className={styles.small}>{products.length} catalog listings. No health claims. No guesswork about what is in a bottle.</p></div></header>
    <aside className={styles.notice} aria-label="Research and affiliate disclosures"><p><strong>Research only. Not for people or animals.</strong>{RESEARCH_ONLY_NOTICE}</p><p><strong>{paid ? "Affiliate disclosure" : "Independent catalog"}</strong>{paid ? "We may earn a commission when you purchase through our supplier links. " : "External supplier links are currently unpaid. "}We are an independent referring website, not the supplier. <Link href="/recommendations">How our links work</Link></p></aside>
