...
export default function RecommendationsPage(){
  ...
  return <div className={styles.page}>
    ...
    <section className={styles.policies} aria-label="Directory and affiliate information">
      ...
      <details><summary>How affiliate links work</summary><p>{paid?"Supplier product links contain our referral attribution. We may earn a commission on qualifying purchases.":"Paid referral attribution is currently inactive."} Links open the exact supplier product page in a new tab. We do not add your search, account information, notes or calculator values. The supplier handles ordering, pricing, availability, delivery and returns. No price, discount or commission payout is guaranteed. Our artwork is original directory artwork, not supplier packaging.</p></details>
      <details><summary>What to check before following a product link</summary><p>Confirm the current product identity, full composition, package amount and batch. Match its certificate of analysis to the exact batch and consult the supplier's research-use restrictions. This directory is not a live inventory feed, and products can change. Read the <a href={SUPPLIER_SOURCES.coa} target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer">supplier's batch reports</a> and <a href={SUPPLIER_SOURCES.researchUse} target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer">research-use rules</a>.</p></details>
    </section>
